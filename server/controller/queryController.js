  ...
  try {
    ...
    if (queryResponse) {
      ...
      return res.status(200).json({
        response: "I'm sorry, but I don't understand what you're asking. Could you please contact the Cure Well Hospital for more information? Hotline : 512-421-3940, Email : curewellsupport@doc.com, Website : curewellhos.lk."
      });
    }
